""" because using MCP servers is also great, but know the tools calling better and for better control, 
    we must use the SDK for tha particular software we are integrating to our agent 
"""
